...
class Departamento_Empleado extends Model<Departamento_EmpleadoAttributes, Departamento_EmpleadoCreationAttributes>
  ...
  Empleado.belongsToMany(Departamento, { through: 'Departamento_Empleado', foreignKey: 'idDepartamento' });
  Departamento.belongsToMany(Empleado, { through: 'Departamento_Empleado', foreignKey: 'idEmpleado' });
