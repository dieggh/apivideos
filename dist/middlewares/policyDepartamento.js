...
exports.policyDepartamento = void 0;
const Administrador_1 = require("../models/Administrador");
const policyDepartamento = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        ...
        if (admin && admin.estatus === '1') {
            ...
            const depar = yield admin.getDepartamentos({
                where: {
                    id: id
                }
            });
...
exports.policyDepartamento = policyDepartamento;
